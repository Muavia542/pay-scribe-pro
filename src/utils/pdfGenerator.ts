...
export const generateEmployeesPDF = (employees: Employee[], month: string, year: string) => {
  ...
  // Add table headers (removed Category column)
  doc.setFontSize(10);
  ...
  employees.forEach((employee, index) => {
    ...
    // Fixed: Removed Category column and ensured correct data mapping
    const rowData = [
      employee.name.substring(0, 20),
      employee.department.substring(0, 18),
      employee.workingDays.toString(), // Fixed: This was correctly showing working days
